...
export default function Home() {
  ...
  const getSpotifyLinkAuthorize = () => {
    ...
    const clientId = "c0fe963f0a3e4ef8bcf641ae76d0904a";

    return `https://accounts.spotify.com/authorize?client_id=${clientId}&response_type=token&redirect_uri=http://localhost:3000/homework3&state=${state}&scope=${config.SPOTIFY_SCOPE}`;
  }
